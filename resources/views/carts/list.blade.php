        ...
        <div class="row">
            <div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
                <div class="m-l-25 m-r--38 m-lr-0-xl">
                        ...
                        <table class="table-shopping-cart">
                            ...
                            $price = $product->price < $product->price_sale ? $product->price : $product->price_sale;
                                ...
                                <tr class="table_row">
                                    ...
                                    <td class="column-3"> {!!\App\Helpers\Helper::price($product->price,
                                        $product->price_sale) !!} đ</td>
                                    <td class="column-4">
                    ...
                    @else
                    <h3 class="flex-w">Giỏ hàng rỗng</h3>
                    @endif
                </div>
            </div>
                    ...
                    <div class="bor12 p-t-15 p-b-30">
                        ...
                        <div class="p-r-18 p-r-0-sm w-full">
                            ...
                            <div class="p-t-15">
                                ...
                                <div class="bor8 bg0 m-b-12">
                                    <textarea class="stext-111 cl8 plh3 size-111 p-lr-15" name="content" placeholder="Ghi chú">
                                        </textarea>
                                </div>
                            </div>
                        </div>
